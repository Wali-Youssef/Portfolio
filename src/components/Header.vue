<template><nav class="bg-gray-800 p-4">
    <div class="flex justify-between items-center">
      ...
      <div class="hidden md:block">
        <div class="flex space-x-4">
          ...
          <RouterLink to="/films/edit" class="text-white hover:text-gray-300">Créer des films</RouterLink>
    ...
    <div id="mobile-menu" class="md:hidden hidden">
      <div class="px-2 pt-2 pb-3 space-y-1 sm:px-3">
        ...
        <RouterLink to="/fimls/edit" class="block text-white hover:text-gray-300">Créer des films</RouterLink>
